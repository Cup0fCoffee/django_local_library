...
class LoanedBookInstancesByUserListViewTest(TestCase):
    ...
    def setUp(self):
        ...
        test_book = Book.objects.create(title='Book Title',
                summary="My book symmary", isbn='ABCDEFG', author=test_author,
        ...
        for book_copy in range(number_of_book_copies):
            ...
            status = 'm'
            BookInstance.objects.create(book=test_book, imprint="Unlikely Imp"\
                    "rint, 2016", due_back=return_date, borrower=the_borrower,
                    status=status)
    ...
    def test_only_borrowed_books_in_list(self):
        ...
        # Check our user is logged in
        self.assertEqual(str(resp.context['user']), 'testuser1')
        #Check tahe we got a response "success"
        self.assertEqual(resp.status_code, 200)
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_redirect_if_logged_in_byt_not_correct_permission(self):
        login = self.client.login(username='testuser1', password='12345')
        resp = self.client.get(reverse('renew-book-librarian',
                kwargs={'pk': self.test_bookinstance1.pk,}))
    ...
    def test_logged_in_with_permission_borrowed_book(self):
        ...
        # Check that it lets us login - this is our book and we have the right premissions.
        self.assertEqual(resp.status_code, 200)
